  ...
  plugins: [
    ...
    function ({ addComponents }) {
      addComponents({
        ...
        ".btn-gray--dark": {
          "@apply w-full sm:w-[264px] h-[40px] flex-center rounded font-medium text-[#eee] bg-[#222] hover:bg-[#393c41] transition-colors duration-300":
            {},
        },
        ".btn-light": {
          "@apply w-full sm:w-[264px] h-[40px] flex-center rounded font-medium text-black bg-white hover:bg-[#e1e1e1] transition-colors duration-300":
            {},
        },
        ".btn-light--blur": {
